...
#
# 注意:
#   部分软件包 ImmortalWrt 已内置，因此相关克隆操作已注释
#
# 作者: Shuery-Shuai
# 版本: 2.0.0
...
#######################################
# 克隆第三方软件包仓库
# 注意: ImmortalWrt 自带部分软件包，因此部分克隆操作已注释
#######################################
...
clone_repo 'https://github.com/Shuery-Shuai/LuciFanXpert.git' \
	'main' \
	'--depth=1' \
...
# 	git sparse-checkout set lang/golang net/dae net/daed utils/fan2go
# )
